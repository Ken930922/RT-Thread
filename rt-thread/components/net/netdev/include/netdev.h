...
void netdev_low_level_set_dhcp_status(struct netdev *netdev, rt_bool_t is_enable); void netdev_set_if(char* netdev_name, char* ip_addr, char* gw_addr, char* nm_addr);
#ifdef __cplusplus
}
#endif
